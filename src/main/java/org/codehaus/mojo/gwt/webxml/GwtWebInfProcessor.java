...
public class GwtWebInfProcessor {
   ...
   private Document webXml;
     ...
     * @throws Exception
     */
    public GwtWebInfProcessor( String moduleName, String targetWebXml, String sourceWebXml, boolean webXmlServletPath )
        throws Exception
    {
        ...
        {
            throw new Exception( "Unable to locate module definition file: " + moduleName.replace( '.', '/' )
                + ".gwt.xml" );
        }
        ...
        catch ( Exception e )
        {
            ...
            try
            {
                ...
                document = builder.build( Thread.currentThread().getContextClassLoader()
                    .getResourceAsStream( "/" + module.replace( '.', '/' ) + ".gwt.xml" ) );
